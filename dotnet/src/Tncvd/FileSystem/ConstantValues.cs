...
namespace Tncvd.FileSystem
{
    public static partial class ConstantValues
    {
        ...
        public const string REL_FILE_PATH_PARENT_DIR_SYMBOL = "..";

        public const char FILE_PATH_DELIMITER_UNIX = '/';
        public const char FILE_PATH_DELIMITER_WINDOWS = '\\';

        public const string ROOT_FILE_PATH_START_WITH_FORMAT_UNIX = "/{0}";
        public const string ROOT_FILE_PATH_START_WITH_FORMAT_WINDOWS = "{0}:";
